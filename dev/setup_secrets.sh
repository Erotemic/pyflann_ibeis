...
~/misc/templates/pyflann_ibeis/dev/setup_secrets.sh
...
=========================
    ...
    cat .setup_secrets.sh | \
        ...
        sed "s|pyflann_ibeis|<YOUR-REPO>|g" | \
    ...
    * Make sure you add Runners to your project 
    https://gitlab.org.com/utils/pyflann_ibeis/-/settings/ci_cd 
    in Runners-> Shared Runners
    and Runners-> Available specific runners

    * Ensure that you are auto-cancel redundant pipelines.
    Navigate to https://gitlab.kitware.com/utils/pyflann_ibeisS/-/settings/ci_cd and ensure "Auto-cancel redundant pipelines" is checked.
