...
Notes:
    ...
    cd /home/joncrall/code/ibeis/tpl/pyflann_ibeis
    mkdir -p docs
    cd docs
    ...
    rm -rf /home/joncrall/code/ibeis/tpl/pyflann_ibeis/docs/source/auto
    cd /home/joncrall/code/ibeis/tpl/pyflann_ibeis/docs
    sphinx-apidoc --private --separate --force --output-dir /home/joncrall/code/ibeis/tpl/pyflann_ibeis/docs/source/auto /home/joncrall/code/ibeis/tpl/pyflann_ibeis/pyflann_ibeis
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/pyflann-ibeis/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: pyflann_ibeis
            Set the Repository URL: https://github.com/Erotemic/pyflann_ibeis

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/pyflann-ibeis/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/pyflann_ibeis/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/pyflann-ibeis/versions/
"""
#
...
copyright = '2026, Jon Crall, Marius Muja'
author = 'Jon Crall, Marius Muja'
modname = 'pyflann_ibeis'

repo_dpath = dirname(dirname(dirname(__file__)))
mod_dpath = join(repo_dpath, 'pyflann_ibeis')
...
# html_logo = '.static/pyflann_ibeis.svg'
# html_favicon = '.static/pyflann_ibeis.ico'
...
latex_documents = [
    (
        master_doc,
        'pyflann_ibeis.tex',
        'pyflann_ibeis Documentation',
        'Jon Crall, Marius Muja',
        'manual',
    ),
]
...
man_pages = [
    (master_doc, 'pyflann_ibeis', 'pyflann_ibeis Documentation', [author], 1)
]
