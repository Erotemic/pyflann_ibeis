...
Notes:
    ...
    rm -rf ~/code/pyflann_ibeis/docs/source/auto
    cd ~/code/pyflann_ibeis/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/pyflann_ibeis/docs/source/auto ~/code/pyflann_ibeis/pyflann_ibeis
...
copyright = '2025, Jon Crall Marius Muja'
...
man_pages = [
    (master_doc, 'pyflann_ibeis', 'pyflann_ibeis Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyflann_ibeis', 'pyflann_ibeis Documentation',
     author, 'pyflann_ibeis', 'One line description of project.',
     'Miscellaneous'),
]
