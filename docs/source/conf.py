...
Notes:
    ...
    sphinx-apidoc -f -o ~/code/pyflann_ibeis/docs/source ~/code/pyflann_ibeis/pyflann_ibeis --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/pyflann_ibeis/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/pyflann_ibeis/versions/
"""
#
...
htmlhelp_basename = 'pyflann_ibeisdoc'
